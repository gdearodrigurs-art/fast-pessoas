import { esquemaNovaVersaoCargo } from "@/dominios/colaboradores/esquemas";
import {
  criarVersaoCargo,
...
export async function POST(
  ...
  try {
    ...
    const analise = esquemaNovaVersaoCargo.safeParse(corpo);
    if (!analise.success) {
    ...
    await criarVersaoCargo(sessao, idNumero, analise.data);
